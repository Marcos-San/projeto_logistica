...
* Gestão de Entregas: CRUD completo com controle de status (pendente, em trânsito, entregue, cancelada) 
* Gestão de Motoristas: Controle completo de motoristas e suas atribuições 
